...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setTopProducts(['TOTVS Protheus', 'TOTVS RM', 'TOTVS Fluig', 'TOTVS Datasul', 'TOTVS Logix']);
    ...
    setCompanies([
      { id: 1, name: 'Itaú Unibanco', logo: itauLogo, people: ['Ana Paula', 'Bruno Silva'], location: 'São Paulo/SP', tagline: 'Banco líder em serviços financeiros', sector: 'Serviços Financeiros', founded: '1945', website: 'https://www.itau.com.br', description: 'Itaú Unibanco oferece soluções bancárias digitais, corporativas e de relacionamento para milhões de clientes.', highlights: ['Bancos digitais', 'Pagamentos', 'Gestão de caixa'], focusAreas: ['Fintech', 'Cartões', 'Empresas'] },
      { id: 2, name: 'Ambev', logo: ambevLogo, people: ['Carlos Edu', 'Daniela M.'], location: 'Rio de Janeiro/RJ', tagline: 'Referência em bebidas e varejo', sector: 'Consumo', founded: '1999', website: 'https://www.ambev.com.br', description: 'Ambev reúne marcas consagradas e soluções de distribuição com forte presença nacional e internacional.', highlights: ['Sustentabilidade', 'Distribuição', 'Branding'], focusAreas: ['Bebidas', 'Logística', 'Comércio'] },
      { id: 3, name: 'Magazine Luiza', logo: magaluLogo, people: ['Elaine S.', 'Fabio J.'], location: 'São Paulo/SP', tagline: 'E-commerce e varejo omnichannel', sector: 'Varejo', founded: '1957', website: 'https://www.magazineluiza.com.br', description: 'Magazine Luiza combina loja física e digital para entregar uma experiência de compra moderna e integrada.', highlights: ['Omnichannel', 'Marketplace', 'Digital'], focusAreas: ['E-commerce', 'Tecnologia', 'Vendas'] },
      { id: 4, name: 'Localiza', logo: localizaLogo, people: ['Gisele R.', 'Hugo V.'], location: 'Belo Horizonte/MG', tagline: 'Mobilidade e aluguel de veículos', sector: 'Transporte', founded: '1973', website: 'https://www.localiza.com', description: 'Localiza oferece soluções de mobilidade para clientes e empresas com frota moderna e operação digital.', highlights: ['Aluguel de carros', 'Frota', 'Tecnologia'], focusAreas: ['Mobilidade', 'Fleet', 'Logística'] },
      { id: 5, name: 'Grupo Fleury', logo: fleuryLogo, people: ['Igor L.', 'Julia T.'], location: 'São Paulo/SP', tagline: 'Saúde diagnóstica de ponta', sector: 'Saúde', founded: '1926', website: 'https://www.fleury.com.br', description: 'O Grupo Fleury oferece medicina diagnóstica com forte atuação em tecnologia, laboratórios e atendimento especializado.', highlights: ['Diagnóstico', 'Pesquisa', 'Inovação'], focusAreas: ['Saúde', 'Laboratórios', 'Bem-estar'] },
      { id: 6, name: 'SEBRAE', logo: sebraeLogo, people: ['Katia M.', 'Leo N.'], location: 'Brasília/DF', tagline: 'Apoio a micro e pequenas empresas', sector: 'Educação', founded: '1972', website: 'https://www.sebrae.com.br', description: 'O SEBRAE promove empreendedorismo e capacitação para pequenos negócios em todo o Brasil.', highlights: ['Empreendedorismo', 'Capacitação', 'Consultoria'], focusAreas: ['PME', 'Treinamento', 'Inovação'] },
      { id: 7, name: 'Assaí Atacadista', logo: assaiLogo, people: ['Marta P.', 'Nuno G.'], location: 'São Paulo/SP', tagline: 'Atacado forte para varejo e indústrias', sector: 'Atacado', founded: '1974', website: 'https://www.assai.com.br', description: 'Assaí Atacadista entrega preços competitivos e variedade para lojas, indústrias e clientes institucionais.', highlights: ['Preços baixos', 'Sortimento', 'Logística'], focusAreas: ['Atacado', 'Bens de consumo', 'Supply chain'] },
      { id: 8, name: 'Atacadão', logo: atacadaoLogo, people: ['Otávio S.', 'Paula F.'], location: 'São Paulo/SP', tagline: 'Rede de atacarejo para varejo e PME', sector: 'Atacado', founded: '1960', website: 'https://www.atacadao.com.br', description: 'Atacadão atende comerciantes e consumidores com os melhores preços e ampla variedade de produtos.', highlights: ['Atacarejo', 'Variedade', 'Economia'], focusAreas: ['Varejo', 'Distribuição', 'Compras'] },
      { id: 9, name: 'Grupo Muffato', logo: muffatoLogo, people: ['Quiteria L.', 'Ruan K.'], location: 'Cascavel/PR', tagline: 'Supermercados e distribuição regional', sector: 'Varejo', founded: '1979', website: 'https://www.muffato.com.br', description: 'Grupo Muffato atua no varejo alimentar com foco em experiência, atendimento local e operação eficiente.', highlights: ['Supermercado', 'Atacado', 'Inovação'], focusAreas: ['Alimentação', 'Varejo', 'Experiência'] },
      { id: 10, name: 'Mart Minas', logo: martMinasLogo, people: ['Soraia B.', 'Tito A.'], location: 'Minas Gerais/MG', tagline: 'Rede de atacado para compras em grande volume', sector: 'Atacado', founded: '1978', website: 'https://www.martminas.com.br', description: 'Mart Minas fornece soluções de abastecimento para negócios com forte presença regional.', highlights: ['Atacado', 'Parcerias', 'Produtos'], focusAreas: ['Agronegócio', 'Comércio', 'Distribuição'] },
      { id: 11, name: 'Arklok', logo: arklokLogo, people: ['Uriel D.', 'Vera C.'], location: 'Curitiba/PR', tagline: 'Engenharia e soluções industriais', sector: 'Indústria', founded: '2005', website: 'https://www.arklok.com.br', description: 'Arklok desenvolve projetos de engenharia industrial e automação voltados para eficiência operativa.', highlights: ['Engenharia', 'Automação', 'Projetos'], focusAreas: ['Indústria', 'Energia', 'Automação'] },
      { id: 12, name: 'Makro Engenharia', logo: makroLogo, people: ['Wagner X.', 'Yara Z.'], location: 'São Paulo/SP', tagline: 'Soluções de engenharia para construção pesada', sector: 'Engenharia', founded: '1990', website: 'https://www.makroengenharia.com.br', description: 'Makro Engenharia atua em infraestrutura, construção pesada e manutenção industrial com foco em segurança.', highlights: ['Infraestrutura', 'Obras', 'Qualidade'], focusAreas: ['Construção', 'Manutenção', 'Segurança'] },
    ]);
  }, []);
